...
public class StringUtil {
	...
	public static final String escapeJavaScript(String value) {
		return org.apache.commons.lang3.StringEscapeUtils.unescapeEcmaScript(value);
	}
	...
	public static void main(String arg[]){
		...
		String s = substringBefore("&itye=110&mid=&coId=9&sign=909090","&sign=");
	 ...
	 * @return  截取后的字符串
	 */
	public static String omitRightNoEllipsis(String str, int len){
		if(str == null) {
			return "";
		}
